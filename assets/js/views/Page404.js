    ...
    render() {
        this.#application.conteneurHTML.innerHTML = `
            <div class="px-6 pt-32 max-w-4xl mx-auto">
              ...
              <a class="underline hover:text-blue-800 transition" href="/">Retour à la page d'accueil</a>
              div class="my-10">
                <img src="assets/img/404.png" alt="erreur 404" class="w-full max-w-3xl mx-auto"/>
